...
wp_enqueue_script( 'underscores',           THEME_URI . '/js/underscore.js',                   array(), null, false );
wp_enqueue_script( 'backbones',           THEME_URI . '/js/backbone.js',                   array(), null, false );
wp_enqueue_script( 'gallerista-core',           THEME_URI . '/js/gallerista/core.js',                   array(), null, false );
wp_enqueue_script( 'gallerista-utils',           THEME_URI . '/js/gallerista/utils.js',                   array(), null, false );
wp_enqueue_script( 'galleristaData',           THEME_URI . '/js/gallerista/data.js',                   array(), null, false );
wp_enqueue_script( 'galleristaTransitions',           THEME_URI . '/js/gallerista/transitions.js',                   array(), null, false );
	wp_enqueue_script( 'carousel',           THEME_URI . '/js/gallerista/carousel.js',                   array(), null, false );
	wp_enqueue_script( 'slideshow',           THEME_URI . '/js/gallerista/slideshow.js',                   array(), null, false );
	wp_enqueue_script( 'featuredprojects',           THEME_URI . '/js/featuredprojects.js',                   array(), null, false );
	wp_enqueue_script( 'flexslider-JS',           THEME_URI . '/js/jquery.flexslider.js',                   array(), null, false );
